...
<div id="container">
	...
	<table class="table table-bordered table-striped table-hover">
		...
		<tr>
			...
			<td>
			      <?php echo anchor('crud_mapel/edit/'.$u->id_mapel,'<button class="btn btn-primary"><span class="glyphicon glyphicon-edit"></span></button>'); ?>
                              <?php echo anchor('crud_mapel/hapus/'.$u->id_mapel,'<button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span></button>'); ?>
			</td>
		</tr>
		<?php } ?>
	</table>
